...
//----------------------------BURDAN ÜSTÜNÜ ÇOK AMA ÇOK GEREK KALMADIKCA ELLEME --------------------------------------\\
...
client.on("message", message => {
    if(message.content.toLowerCase() == "byramin") 
    return message.channel.send(`ByRamin adamdır :heart: :heart:`)
});
...
client.on("message", message => {
    ...
    return message.channel.send(`${message.author}, Xd :D`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == ".d") 
    return message.channel.send(`${message.author}, :D :D :D`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "hg") 
    return message.channel.send(`${message.author}, Her yeni gelene Bunu de dostum seviliyorsun`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "hb") 
    return message.channel.send(`${message.author}, Nasılsın ?`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "iyiyim sen") 
    return message.channel.send(`${message.author}, İyidir Ben kaçtım kb`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "deneme") 
    return message.channel.send(`${message.author}, @:crown: Owner Of ByRamin `)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "!tag") 
    return message.channel.send(`${message.author}, Tag için "tag" yaz`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "register") 
    return message.channel.send(`${message.author}, Kayıt rolü için Yetkili alım formu doldur`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "konuş") 
    return message.channel.send(`${message.author}, **sa,selam,merhaba,byramin,s.a,mrb,slm,xd,.d,hg,hb,iyiyim sen,!tag,register,konuş** Bunlardan birini yazarsan konuşturabilirsin`)
});

client.on("message", message => {
    if(message.content.toLowerCase() == "ayıp") 
    return message.channel.send(` **Lütfen Küfür etme**`)
});
...
db.delete(`cezali_${member.guild.id + member.id}`)
    ...
    member.roles.remove('794938716040593448');
  }, ms(sürejail));
}
})
...
db.delete(`muteli_${member.guild.id + member.id}`)
    ...
    member.roles.remove('794938679369924638');
  }, ms(süre));
}
})
